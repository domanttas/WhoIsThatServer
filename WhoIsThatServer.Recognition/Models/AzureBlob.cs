...
namespace WhoIsThatServer.Storage.Models
{
    public class AzureBlob
    {
        ...
        public AzureBlob()
        {
            ...
            StorageConnectionString = "DefaultEndpointsProtocol=https;AccountName=whoisthatserverimages;AccountKey=7nJ73XYUJyGrNKs6MYQRnfD80AnkmAOmgvBMc7WSqiVGM0wF2HntAZNPDNctmo44yoQ+iIjVqVjucLMMiCDv+w==";
